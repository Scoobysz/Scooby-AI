...
def takeResponse():
    ...
    with sr.Microphone() as source:
        ...
        try:
            ...
            print("Error recognizing user response:", e)
            return ""
...
def takeCommand():
    ...
    last_user_activity_time = time.time()  # Initialize the time of the last user activity
            ...
            with sr.Microphone() as source:
                ...
                try:
                    ...
                    if "scooby" in query.lower():
                        ...
                        print(last_user_activity_time)

                except Exception as e:
                    pass
    #print(time.time() - last_user_activity_time)
    if time.time() - last_user_activity_time > 20:
    ...
    while wake_word_detected:
        ...
        if "play music" in response.lower():
        ...
        elif "stop" in response.lower() and is_speaking:
            say("Okay, stopping.")
            is_speaking = False
        elif "weather forecast" in response.lower():
            say("Sure, for which city would you like to know the weather?")
            city = takeResponse()
            weather_info = get_weather(city)
            say(weather_info)
        elif "news" in response.lower():
